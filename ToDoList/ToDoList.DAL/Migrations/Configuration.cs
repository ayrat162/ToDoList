...
namespace ToDoList.DAL.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ToDoList.DAL.EF.ToDoListContext>
    {
        ...
        protected override void Seed(ToDoList.DAL.EF.ToDoListContext context)
        {
            ...
            context.ToDoTasks.Add(new ToDoTask { Description = "Task 1", DueDateTime = DateTime.Now, Status = "WIP", UserId = "657dd80a-3516-40f8-93cd-3c7a41d19af2" });
            context.ToDoTasks.Add(new ToDoTask { Description = "Task 2", DueDateTime = DateTime.Now, Status = "WIP", UserId = "657dd80a-3516-40f8-93cd-3c7a41d19af2" });
            ...
            context.ToDoTasks.Add(new ToDoTask { Description = "Task 5", DueDateTime = DateTime.Now, Status = "WIP", UserId = "657dd80a-3516-40f8-93cd-3c7a41d19af2" });
            context.SaveChanges();
